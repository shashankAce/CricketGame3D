    ...
    execute: function () {
      ...
      _export("BaseSwingData", BaseSwingData = (_dec = ccclass('BaseSwingData'), _dec2 = executeInEditMode(true), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property({
        ...
        capturePose() {
          ...
          var batLocalRot = new Quat();
          Quat.multiply(batLocalRot, invRootRot, this.batRoot.worldRotation); // Grips (already local)

          var rightGripLocal = this.gripRight.position.clone();
          var leftGripLocal = this.gripLeft.position.clone(); // Poles

          var rightPoleLocal = new Vec3();
        ...
        formatPose(pose) {
          var v = v => "new Vec3(" + v.x.toFixed(3) + ", " + v.y.toFixed(3) + ", " + v.z.toFixed(3) + ")";

          var q = q => "new Quat(" + q.x.toFixed(3) + ", " + q.y.toFixed(3) + ", " + q.z.toFixed(3) + ", " + q.w.toFixed(3) + ")";
